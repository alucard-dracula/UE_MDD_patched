...
void FUbaHordeAgentManager::SetAddClientCallback(CAddClientCallback* Callback, void* UserData)
{
	AddClientCallback = nullptr;
	AddClientCallback_c = Callback;
