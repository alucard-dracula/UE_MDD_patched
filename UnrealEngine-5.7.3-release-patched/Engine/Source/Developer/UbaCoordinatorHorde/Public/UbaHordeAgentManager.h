...
public:
	...
	// yggdrasil patched
	using CAddClientCallback = bool(void* UserData, const uba::tchar* Ip, uint16 Port);
	UBACOORDINATORHORDE_API void SetAddClientCallback(CAddClientCallback* Callback, void* UserData);
...
private:
	...
	CAddClientCallback* AddClientCallback_c = nullptr; // yggdrasil patched
