...
public class GoogleTest : ModuleRules
{
	public GoogleTest(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
        {
			...
			if (Target.Configuration == UnrealTargetConfiguration.Debug && Target.bDebugBuildsActuallyUseDebugCRT)
			{
				PublicAdditionalLibraries.Add(LibraryPath + "gtestd.lib");
				PublicAdditionalLibraries.Add(LibraryPath + "gmockd.lib");
				PublicAdditionalLibraries.Add(LibraryPath + "gmock_maind.lib");
			}
			else
			{
				PublicAdditionalLibraries.Add(LibraryPath + "gtest.lib");
